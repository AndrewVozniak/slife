    ...
    <div class="content_wrapper">
        <div class="container">
            <div class="info_wrapper">
                ...
                <div class="info_text">
                    <p class="delivery_1_paragraph">{{__('delivery.important_to_the_client')}}</p>
                    ...
                    <p class="delivery_title">{{__('delivery.delivery_options')}}</p>
                    ...
                    <p class="delivery_options_bottom">{{__('delivery.delivery_new_post')}}&#46;</p>

                    <p class="text_500_16_black">{{__('delivery.ukr_post')}}&#58;</p>
                    <p>{{__('delivery.delivery_registration')}}&#46;</p>
                    <p style="margin-bottom: 8px">{{__('delivery.sending_mode')}}&#58;</p>
                    <ul class="ukr_post_ul">
                    ...
                    <div class="delivery_address">
                        ...
                        <p style="margin-bottom: 0">{{__('delivery.address')}}&#46;</p>
                    </div>

                    <div class="delivery_address_768">
                        <p style="margin-bottom: 32px">{{__('delivery.client_can')}}&#46;
                            {{__('delivery.address')}}&#46;
                        </p>
                    </div>

                    <p class="delivery_cost">{{__('delivery.delivery_cost')}}</p>
                    ...
                    <p class="delivery_cost">{{__('delivery.payment_for_the_purchase')}}</p>
                    <p style="margin-bottom: 8px">{{__('delivery.payment_options')}}&#58;</p>
                    ...
                    <p style="margin-bottom: 0">{{__('delivery.customer_can')}}&#46;</p>
                </div>
            </div>
        </div>
    </div>
