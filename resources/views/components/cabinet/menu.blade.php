        ...
        <div class="personal_info_box">
            <div class="different_icon_box">
                <svg
                    ...
                    <rect width="67" height="67" @if($activeTab == 'personal_data') class="active" @endif/>
                    <path d="M40.922 31.14L41.849 30.213C42.5864 29.4755 43.0007 28.4754
                                  ...
                                  41.301L25.199 43.177Z" @if($activeTab == 'personal_data') class="active" @endif/>
                </svg>
            </div>
            <div class="personal_info font_style">
                <a href="{{ route('personalData', ['locale' => App::currentLocale()])  }}">{{ __('personal_date.personal_date') }}</a>
            </div>
        </div>
        ...
        <div class="personal_info_box">
            <div class="different_icon_box">
                <svg
                    ...
                    <rect width="67" height="67" @if($activeTab == 'order_history') class="active" @endif/>
                    <path d="M28.5 39.5C28.8978 39.5 29.2794 39.658
                          ...
                          stroke="black" @if($activeTab == 'order_history') class="active" @endif/>
            ...
            <div class="personal_info font_style">
                <a href="{{ route('orderHistory', ['locale' => App::currentLocale()])  }}">{{ __('personal_date.order_history') }}</a>
            </div>
        </div>
        ...
        <div class="personal_info_box">
            <div class="different_icon_box">
                <svg
                    width="67" height="67" viewBox="0 0 67 67"
                    fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="67" height="67" @if($activeTab == 'my_bonuses') class="active" @endif/>
                    <path d="M43 33.5H23M33 23.5V43.5M34 33.5C34 34.5609 34.4214 35.5783 35.1716 36.3284C35.9217 37.0786 36.9391 37.5 38 37.5M32 33.5C32 34.5609 31.5786 35.5783 30.8284 36.3284C30.0783 37.0786 29.0609 37.5 28 37.5"
                          stroke="black" stroke-width="1.5" stroke-linecap="round" @if($activeTab == 'my_bonuses') class="active" @endif/>
                    <path d="M33.0027 31.535C33.0033 30.8109 33.2456 30.1078 33.6912 29.5371C34.1369 28.9665 34.7604 28.561 35.4627 28.385C37.0657 27.985 38.5187 29.437 38.1177 31.041C37.9417 31.7433 37.5362 32.3668 36.9655 32.8124C36.3949 33.2581 35.6918 33.5004 34.9677 33.501H33.0027M33.0027 31.535V33.501M33.0027 31.535C33.0021 30.8109 32.7598 30.1078 32.3141 29.5371C31.8685 28.9665 31.245 28.561 30.5427 28.385C28.9397 27.985 27.4867 29.437 27.8877 31.041C28.0637 31.7433 28.4692 32.3668 29.0398 32.8124C29.6105 33.2581 30.3136 33.5004 31.0377 33.501H33.0027"
                          stroke="black" stroke-width="1.5" @if($activeTab == 'my_bonuses') class="active" @endif/>
            ...
            <div class="personal_info font_style">
                <a href="{{ route('myBonuses', ['locale' => App::currentLocale()])  }}">{{ __('personal_date.my_bonuses') }}</a>
            </div>
        </div>
    </div>

    <a href="#" class="exit_box">
        <span class="exit_text">{{ __('personal_date.exit') }}</span>
        <img src="{{asset('storage/images/icons/exit.svg')}}" alt="exit" class="exit_img">
    </a>
</div>

<div class="personal_data_container_mobile">
    <div class="personal_box_mobile">
        <div class="avatar_mobile">OT</div>

        <div class="personal_name_box_mobile">
            <span class="personal_name_mobile">Олександра Таран</span>

            <a href="#" class="exit_box_mobile">
                <span class="exit_text_mobile">{{ __('personal_date.exit') }}</span>
                <img src="{{asset('storage/images/icons/exit.svg')}}" alt="exit" class="exit_img_mobile">
            </a>
        </div>
    </div>
    ...
    <div class="personal_data_menu_options_mobile">
        ...
        <div class="personal_data_menu_mobile" id="personal_data_menu_mobile">
            <div class="personal_info_box">
                <div class="different_icon_box">
                    <svg
                        width="67" height="67" viewBox="0 0 67 67" fill="none"
...
<script>
    function toggleButtonMenu() {
        const personal_data_menu_mobile = document.getElementById('personal_data_menu_mobile');
        personal_data_menu_mobile.classList.toggle('hidden');
    }
</script>
