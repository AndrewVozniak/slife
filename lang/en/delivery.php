...
return [
    ...
    'warehouse_warehouse' => 'Warehouse-Warehouse: the customer independently receives the parcel at the previously specified
        branch of his city',
    ...
    'delivery_new_post' => 'Delivery by this company takes from 1 to 3 days. We make shipments every working day. If the
        customer has made a purchase and made payment (partial or full) before 14:30, the shipment is made on the same day.
        Dispatch on Saturday is carried out until 11:30',
    'ukr_post' => 'Ukrposhta',
    'delivery_registration' => 'Delivery by this carrier is made every working day. Sending modes: Branch to Branch',
    'sending_mode' => 'Sending mode',
    'branch_branch' => 'Branch to Branch',
    'delivery_terms' => 'The terms are individual and depend on the distance of transportation and the load of the
        transportation operator on a particular day.Detailed terms for your region can be found on the official website of Ukrposhta',
    ...
    'for_customers_abroad' => 'For our customers abroad, we have prepared a new offer - international delivery of orders. The
        shipment is carried out by the logistics companies Nova Poshta and Ukrposhta. Delivery time is from 3 days depending
        on the country of destination. The cost is calculated individually for each order',
    ...
    'client_can' => 'The customer can pick-up the goods from our warehouse on their own. The option of pick up is available after
        prior agreement by phone with our manager',
    ...
    'delivery_of_oversize_parcels' => 'The cost of delivery of oversized parcels is calculated individually and must be agreed with
        a client',
    ...
    'customer_can' => 'The customer can also choose to pay after receiving the parcel. The option is available subject to
